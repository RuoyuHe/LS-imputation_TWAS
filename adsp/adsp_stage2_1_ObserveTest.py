...
r = robjects.r
r['source']('/home/panwei/he000176/deepRIV/ImputedTraits/code/adsp/adsp_stage1_FUN_impute.R')
...
common_path = out_path + 'results/adsp/common_{}_{}.txt'.format(pheno_study,file_num)
IVa_path = out_path + 'results/adsp/IVa_{}_{}.txt'.format(pheno_study,file_num)
debug_path = out_path + 'results/debug/adsp/gene/gene_{}_{}'.format(pheno_study,file_num)
...
try:
    for gene_ind in range(start, end):
        ...
        with localconverter(robjects.default_converter + pandas2ri.converter):
            ...
            #
            ukb_snp = robjects.conversion.rpy2py(stage1_results['ukb_snp_bed'])
        ...
        IVa_results = pd.concat([IVa_results, 
            pd.DataFrame(np.concatenate((IVa_pg_adsp, IVa_pnl_adsp,
                                        ...
                                        [y_adsp_ID.shape[0]], [Y_ID.shape[0]], [gene_ind])).reshape(1,-1))], 
            axis = 1)
